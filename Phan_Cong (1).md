...
pipeline {
  ...
  stages {
    stage('Get Commit ID từ branch') {
      steps {
        script {
          // Tải mã nguồn về workspace
          checkout([$class: 'GitSCM', branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[url: 'https://github.com/Nat90711/project-devops-yas.git']]])
